...
$thisyear='2013';
$lastyear='2012';
$current_year_prices = getAveragePrices($connection,$thisyear);
$previous_year_prices = getAveragePrices($connection,$lastyear);
...
function getAveragePrices($connection, $year)
{
    $sqlAverageCheck = "SELECT week, price FROM average_weekly_prices WHERE year = '$year'";
    $sqlAverageResult = mysqli_query($connection,$sqlAverageCheck);
	if (!$sqlAverageResult) {
